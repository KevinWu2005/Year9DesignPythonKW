...
class Tab1_Frame1(Frame):
    def __init__(self, master):
        Frame.__init__(self, master)
        self.label = Label(self, text="Cube Volume Calculator")
...
class Tab2(Frame):
    def __init__(self, master):
        Frame.__init__(self, master)
        self.label = Label(self, text="Cylinder Volume Calculator")
        self.label.pack()
...
class Tab3(Frame):
    def __init__(self, master):
        Frame.__init__(self, master)
        self.label = Label(self, text="Cone Volume Calulator")
        self.label.pack()
...
class Tab4(Frame):
    def __init__(self, master):
        Frame.__init__(self, master)
        self.label = Label(self, text="Rectangular Prism")
        self.label.pack()
